...
!function(t, e) {
    ...
    var _ = setTimeout
      , E = clearTimeout;
    function A(t, e) {
        e.useNativeTimers ? (t.setTimeoutFn = _.bind(k),
        t.clearTimeoutFn = E.bind(k)) : (t.setTimeoutFn = setTimeout.bind(k),
    ...
    var X = J
      ...
      , Q = function(t) {
        ...
        function o() {
            var t;
            return e(this, o),
            (t = n.apply(this, arguments)).polling = !1,
            t
        }
        return r(o, [{
            key: "name",
        ...
        function s(t) {
            ...
            "undefined" != typeof location) {
                var o = "https:" === location.protocol
                  , i = location.port;
                i || (i = o ? "443" : "80"),
                r.xd = "undefined" != typeof location && t.hostname !== location.hostname || i !== t.port,
                r.xs = t.secure !== o
            }
    ...
    : function(t, e) {
      ...
      , ut = function(n) {
        ...
        function a(n) {
            ...
            i.port = n.port,
            n.query && (i.query = n.query)) : i.host && (i.hostname = v(i.host).host),
            A(c(r), i),
      ...
      , _t = function(n) {
        ...
        return r(a, [{
            ...
            value: function(t) {
                var e;
                if ("string" == typeof t)
                    (e = this.decodeString(t)).type === bt.BINARY_EVENT || e.type === bt.BINARY_ACK ? (this.reconstructor = new Et(e),
                    0 === e.attachments && f(s(a.prototype), "emitReserved", this).call(this, "decoded", e)) : f(s(a.prototype), "emitReserved", this).call(this, "decoded", e);
                else {
                    if (!dt(t) && !t.base64)
      ...
      , Ct = function(t) {
        ...
        return r(o, [{
            ...
            value: function(t) {
                ...
                return c || (this.connected ? this.packet(o) : this.sendBuffer.push(o)),
                this.flags = {},
                this
            }
        }, {
    ...
    var Bt = function(n) {
        ...
        function s(n, r) {
            ...
            i.uri = n;
            var u = r.parser || At;
            return i.encoder = new u.Encoder,
